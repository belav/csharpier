...
public class DocPrinterTests
{
  ...
  {
    var doc = Docs.Group(Docs.Concat("1", Docs.Line, "2", Docs.HardLine, "3"));
  ...
  {
    var doc = Docs.Group(
      Docs.Concat("1", Docs.Line, "2", Docs.Line, "3", Docs.BreakParent)
    );
  ...
  {
    var doc = Docs.Group("another", Docs.Line, Docs.IfBreak("break", "flat"));
  ...
  public void Trim_Should_Trim_Indentation()
  {
    var doc = Docs.Concat(
      "{",
      Docs.Indent(Docs.HardLine, "1", Docs.HardLine, Docs.Trim, "#if"),
      Docs.HardLine,
      "}"
    );
  ...
  {
    var doc = Docs.Concat(
      Docs.Indent("1", Docs.HardLine, Docs.HardLineIfNoPreviousLine, "2")
    );
