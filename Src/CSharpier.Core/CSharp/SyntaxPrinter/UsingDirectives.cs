...
internal static class UsingDirectives
{
    ...
    )
    {
        ...
        yield return globalSystemUsings.OrderBy(o => o, Comparer).ToList();
        yield return globalUsings.OrderBy(o => o, Comparer).ToList();
        yield return globalAliasUsings.OrderBy(o => o, Comparer).ToList();
        yield return systemUsings.OrderBy(o => o, Comparer).ToList();
        yield return aliasNameUsings.OrderBy(o => o, Comparer).ToList();
        yield return regularUsings.OrderBy(o => o, Comparer).ToList();
        yield return staticSystemUsings.OrderBy(o => o, Comparer).ToList();
        yield return staticUsings.OrderBy(o => o, Comparer).ToList();
        yield return aliasUsings.OrderBy(o => o, Comparer).ToList();
