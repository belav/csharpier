...
public partial class SyntaxNodeJsonWriter
{
  ...
  public static void WriteIdentifierNameSyntax(
    ...
    properties.Add(
      WriteBoolean("isStructuredTrivia", syntaxNode.IsStructuredTrivia)
    );
    properties.Add(
      WriteBoolean("hasStructuredTrivia", syntaxNode.HasStructuredTrivia)
    );
    properties.Add(
      WriteBoolean("containsSkippedText", syntaxNode.ContainsSkippedText)
    );
    properties.Add(
      WriteBoolean("containsDirectives", syntaxNode.ContainsDirectives)
    );
    properties.Add(
      WriteBoolean("containsDiagnostics", syntaxNode.ContainsDiagnostics)
    );
    properties.Add(
    ...
    properties.Add(
      WriteBoolean("containsAnnotations", syntaxNode.ContainsAnnotations)
    );
  ...
  public static void WriteGenericNameSyntax(
    ...
    properties.Add(
      WriteBoolean("isUnboundGenericName", syntaxNode.IsUnboundGenericName)
    );
    properties.Add(WriteInt("arity", syntaxNode.Arity));
    properties.Add(WriteBoolean("isVar", syntaxNode.IsVar));
    properties.Add(WriteBoolean("isUnmanaged", syntaxNode.IsUnmanaged));
  ...
  public static void WriteExpressionStatementSyntax(
    ...
    properties.Add(
      WriteBoolean("allowsAnyExpression", syntaxNode.AllowsAnyExpression)
    );
    properties.Add(WriteInt("rawKind", syntaxNode.RawKind));
    properties.Add(WriteBoolean("isMissing", syntaxNode.IsMissing));
    properties.Add(
