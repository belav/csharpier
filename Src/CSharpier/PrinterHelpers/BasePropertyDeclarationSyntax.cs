...
public partial class Printer
{
          ...
          Docs.Group(
            Docs.Indent(
              node.AccessorList.Accessors.Select(
                  o => this.PrintAccessorDeclarationSyntax(o, separator)
                )
                .ToArray()
            )
          ),
      ...
      Docs.Concat(
        ...
        explicitInterfaceSpecifierSyntax != null
          ? Docs.Concat(
              ...
              this.PrintSyntaxToken(explicitInterfaceSpecifierSyntax.DotToken)
            )
          : Doc.Null,
        identifier,
        contents,
  ...
  private Doc PrintAccessorDeclarationSyntax(
    ...
    {
      docs.Add(this.PrintArrowExpressionClauseSyntax(node.ExpressionBody));
    }
