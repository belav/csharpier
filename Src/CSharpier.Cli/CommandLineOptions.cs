    ...
    public static RootCommand Create()
    {
        var rootCommand = new RootCommand
        {
            new Argument<string[]>("directoryOrFile")
            {
                ...
                Description =
                    "One or more paths to a directory containing C# files to format or a C# file to format. It may be ommited when piping data via stdin. If a path is not specified the current directory is used"
            }.LegalFilePathsOnly(),
            new Option(
                new[] { "--check" },
