# cli-formatting-pipeline

## Purpose

The observable behavior of the CLI file-formatting flow — input-source handling (stdin vs. paths), file discovery with ignore/generated filtering, the per-file formatting/validation/write sequence, result counting, and exit-code determination. These requirements characterize the existing behavior of the CLI formatting flow and serve as the acceptance contract preserved across internal refactors.
